    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#FFFAF6" }}>
      ...
      <main className="pt-36 pb-24 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-[14px] opacity-50 mb-16" style={{ color: "#1A1A1A" }}>
            Last updated: {new Date().toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })}
          </p>

          <div className="space-y-12 text-[15px] font-light leading-relaxed" style={{ color: "#1A1A1A" }}>

            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>1. Who We Are</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>2. Information We Collect</h2>
              ...
              <ul className="mt-3 space-y-2 list-none">
                {[
                  ...
                  <li key={item} className="flex items-start gap-3 opacity-80">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full shrink-0" style={{ backgroundColor: "#B48C4C" }} />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>4. Legal Basis for Processing</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>5. Data Sharing</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>6. Data Retention</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>7. Your Rights</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>8. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>9. Security</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>10. Changes to This Policy</h2>
              <p>
            ...
            <section className="pt-6 border-t border-[#1A1A1A]/10">
              <h2 className="text-lg font-semibold mb-4" style={{ color: "#1A1A1A" }}>Contact</h2>
              <p>
      ...
      {/* FOOTER */}
      <footer className="py-10 px-6 md:px-12 border-t border-[#B48C4C]/20 text-sm" style={{ backgroundColor: "#FFFAF6", color: "rgba(44,44,44,0.5)" }}>
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <Link href="/" className="font-extrabold hover:text-[#B48C4C] transition-colors" style={{ color: "#1A1A1A" }}>HAMZURY</Link>
          <div className="flex gap-6">
            <Link href="/bizdoc" className="hover:text-[#B48C4C] transition-colors">BizDoc</Link>
            <Link href="/systemise" className="hover:text-[#B48C4C] transition-colors">Systemise</Link>
            <Link href="/skills" className="hover:text-[#B48C4C] transition-colors">Skills</Link>
            <Link href="/founder" className="hover:text-[#B48C4C] transition-colors">Founder</Link>
            <Link href="/terms" className="hover:text-[#B48C4C] transition-colors">Terms</Link>
          </div>
        </div>
      </footer>
    </div>
