      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 17, color: INK, fontWeight: 600, letterSpacing: -0.3 }}>CEO Portal</div>
            <div style={{ fontSize: 10, color: INK_MUTED, marginTop: 4 }}>Executive Control</div>
          </div>
          {isMobile && (
            <button
              onClick={() => setMobileNavOpen(false)}
        ...
        <div style={{ padding: "12px 12px 16px", borderTop: `1px solid ${HAIRLINE}` }}>
          <Link href="/" style={{
            ...
            borderRadius: 10, color: INK_MUTED, fontSize: 12, fontWeight: 500, textDecoration: "none",
            marginBottom: 2,
          }}>
