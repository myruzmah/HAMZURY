...
// 2026-04-25 — Section list aligned to Phase 4 BizDev 5-tab spec
// (Overview, Partnerships, Grants, Affiliates, Calendar). Cut: leads
// (CSO owns lead pipeline), campaigns, sponsorships, templates, tasks,
// targets (Targets-from-CEO inbox is a CEO-portal concern).
type Section =
  | "dashboard" | "affiliates" | "partnerships"
  | "grants" | "calendar";
...
export default function BizDevPortal() {
  ...
  // 2026-04-25 — NAV reduced to Phase 4 BizDev 5-tab spec.
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 17, color: INK, fontWeight: 600, letterSpacing: -0.3 }}>BizDev Portal</div>
            <div style={{ fontSize: 10, color: INK_MUTED, marginTop: 4 }}>Growth Engine</div>
          </div>
          {isMobile && (
            <button
              onClick={() => setMobileNavOpen(false)}
      ...
      <main style={{
        ...
        <div style={{ flex: 1, minHeight: 0, overflowY: "auto", overflowX: "hidden" }}>
          <div style={{
            ...
            {/* 2026-04-25 — Dispatcher reduced to Phase 4 BizDev 5-tab spec. */}
...
function DashboardSection({ onGoto }: { onGoto: (s: Section) => void }) {
  // 2026-04-25 — Dashboard reduced to Phase 4 BizDev Overview spec.
  // Cut: leads + tasks queries (sections cut, off-spec).
  ...
  return (
    <div>
      ...
      {/* 2026-04-25 — "Today's Priorities" card (leads + tasks digest) removed alongside their section cuts. */}
    </div>
  );
}
 ...
 * 2. LEADS & SOURCES
 * ═══════════════════════════════════════════════════════════════════════ */
/* ── CUT 2026-04-25 — Leads section (CSO owns leads pipeline per Phase 4 spec) removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */
 ...
 * ═══════════════════════════════════════════════════════════════════════ */
/* ── CUT 2026-04-25 — Tasks section removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */
 ...
 * ═══════════════════════════════════════════════════════════════════════ */
/* ── CUT 2026-04-25 — AddLeadModal (only used by Leads) removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */

/* ═══════════════════════════════════════════════════════════════════════
 * WEEKLY TARGETS INBOX — BizDev sees targets from CEO, submits outcomes
 * ═══════════════════════════════════════════════════════════════════════ */
/* ── CUT 2026-04-25 — Weekly Targets Inbox section (Targets from CEO) removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */
...
/* ─── Campaigns ───────────────────────────────────────────────────────── */
/* ── CUT 2026-04-25 — Campaigns section removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */
...
/* ─── Sponsorships ────────────────────────────────────────────────────── */
/* ── CUT 2026-04-25 — Sponsorships section removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */

/* ─── Templates ───────────────────────────────────────────────────────── */
/* ── CUT 2026-04-25 — Templates section removed (Phase 4 BizDev Dashboard 5-tab spec: Overview, Partnerships, Grants, Affiliates, Calendar). ── */
