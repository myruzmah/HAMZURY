...
// 2026-05-07 — OFFER_CATEGORIES + types moved to client/src/lib/offer-categories.ts
// so /hub/admin Programs tab can render the same source. The legacy inline
// definition below is preserved as comments showing what used to be here:
// (CourseItem, OfferCategory, OFFER_CATEGORIES, STATUS_BADGE — all imported above)
// Removed inline definition: OFFER_CATEGORIES legacy block was here.
