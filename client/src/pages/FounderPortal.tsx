...
/* 2026-04 founder decision: Reports tab removed — not in spec
   (Founder Life & Legacy System per PHASE1_FOUNDER spec has 7 tabs:
   dashboard, debt, schedule, content, learning, vision, vault).
   Backend (report_requests table + tRPC endpoints) kept dormant
   in case the feature returns. */
