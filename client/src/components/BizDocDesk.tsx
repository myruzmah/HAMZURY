...
const BIZDOC_WA = "2348067149356";

// Available appointment slots (Mon–Fri, WAT)
const APPT_SLOTS = [
  "Monday · 9:00 AM",
  "Monday · 11:00 AM",
  "Monday · 2:00 PM",
...
export function BizDocDesk({ open, onClose, preselectedService }: Props) {
  ...
  const confirmPaymentMutation = trpc.bizdoc.confirmPayment.useMutation();
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
          ...
          {phase === "contact" && showAppt && (
            <div className="rounded-2xl p-4 border" style={{ backgroundColor: W, borderColor: `${Au}50` }}>
              <p className="text-sm font-semibold mb-0.5" style={{ color: G }}>Book a Clarity Call</p>
