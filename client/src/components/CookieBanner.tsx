...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9999] px-4 pb-4 md:px-8 md:pb-6">
      <div
        className="max-w-3xl mx-auto rounded-2xl shadow-2xl border border-[#B48C4C]/20 px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4"
      ...
      >
        <p className="text-[13px] flex-1 leading-relaxed" style={{ color: "rgba(248,245,240,0.75)" }}>
          ...
          <Link href="/privacy" className="underline hover:opacity-80 transition-opacity" style={{ color: "#B48C4C" }}>
            Privacy Policy
          </Link>
          .
        </p>
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            style={{ backgroundColor: "#B48C4C", color: "#1A1A1A" }}
          >
            Accept
          </button>
        </div>
