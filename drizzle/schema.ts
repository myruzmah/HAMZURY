...
export const staffUsers = mysqlTable("staffUsers", {
  ...
  hamzuryRole: mysqlEnum("staffHamzuryRole", ["founder","ceo","cso","cso_staff","finance","hr","bizdev","bizdev_staff","media","skills_staff","systemise_head","tech_lead","compliance_staff","security_staff","department_staff","scalar_lead","scalar_staff","medialy_lead","medialy_staff","podcast_lead","podcast_staff","video_lead","video_staff","faceless_lead","faceless_staff"]).notNull(),
